module.exports = function (){
        ...
        function btnStopSpinning(e) {
                ...
                e(document).on("click",
                function(n) {
                        e("#notice-headerbox").find(n.target).length || e("#notice-headerbox .notice.open").removeClass("open").children(".dropdown-box").slideUp(200),
                        e("#user-headerbox").find(n.target).length || e("#user-headerbox.open").removeClass("open").children(".user-options").slideUp(400),
                        e("#search-headerbox").find(n.target).length || e("#search").is(":visible") && e("#search").slideToggle()
                })
        }).apply(this, [jQuery]),
        function(e) {
                "use strict";
                var n = function(n) {
                        ...
                        n.on("click.toggleClass.fireEvent",
                        function(n) {
                                n.preventDefault(),
                                e(s).toggleClass(t)
                        })
        ...
        function(e) {
                "use strict";
                function n(n) {
                        n.children("ul.child-nav").slideDown(500,
                        function() {
                                e(this).css("display", "")
                        }),
                ...
                function s(n) {
                        ...
                        n.children("ul.child-nav").slideUp(300,
                        function() {
                                e(this).css("display", ""),
                ...
                var t = e("#main-nav");
                t.on("click", "li.close-item",
                function(t) {
                        t.stopPropagation();
                        var i = e(this);
                        n(i),
                        i.siblings("li.open-item").each(function() {
                                s(e(this))
                        })
                }),
                t.on("click", "li.open-item",
                function(n) {
                        n.stopPropagation(),
                        s(e(this))
                }),
                t.on("click", "li.active-item",
                function(e) {
                        e.stopPropagation()
                })
        }.apply(this, [jQuery]),
        ...
        function(e) {
                ...
                e("#notice-headerbox .notice i").on("click",
                function() {
                        var i = e(this).parent();
                        i.toggleClass("open"),
        ...
        function(e) {
                "use strict";
                e(".panel").on("click", ".toggle-panel.panel-expand",
                function() {
                ...
                e(".panel").on("click", ".toggle-panel.panel-collapse",
                function() {
                        var n = e(this).closest(".panel");
                        n.children(".panel-content, .panel-footer").slideDown(400),
                        e(this).addClass("panel-expand").removeClass("panel-collapse")
                }),
                e(".panel").on("click", ".remove-panel",
                function() {
                        var n = e(this).closest(".panel"),
                        s = n.parent();
                        s.is('[class*="col-"]') && 1 == s.children().length ? s.fadeOut(500,
                        function() {
                                s.remove()
                        }) : n.fadeOut(300,
                        function() {
        ...
        function(e) {
                ...
                e(".left-sidebar-toggle").on("click",
                function() {
